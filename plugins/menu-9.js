 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `💬 ${pmenus} All`, rowId: ".m9 all", description: "Menampilkan Semua command BOT"},
	    {title: `🌱 ${pmenus} Rpg`, rowId: ".m9 rpg", description: "Game Epic Rpg!"},
	{title: `✨ ${pmenus} Exp`, rowId: ".m9 xp", description: "Ayo tingkatkan pangkat mu!"},
	{title: `🎮 ${pmenus} Game`, rowId: ".m9 game", description: "Gamenya seru seru lho >-<"},
	{title: `🧩 ${pmenus} Fun`, rowId: ".m9 fun", description: "Fitur yang aman untuk keluarga"},
	{title: `🐚 ${pmenus} Kerang`, rowId: ".m9 kerangajaib", description: "Tanyakan pada ketua club"},
	{title: `📑 ${pmenus} Quotes`, rowId: ".m9 quotes", description: "Random Inspirasi"},
	{title: `⛩️ ${pmenus} Anime`, rowId: ".m9 anime", description: "Kamu wibu ya bang?"},
	{title: `🔞 ${pmenus} Nsfw`, rowId: ".m9 nsfw", description: "Tch, dasar sagne"},
	{title: `🌟 ${pmenus} Premium`, rowId: ".m9 premium", description: "Only premium Users"},
	{title: `🎭 ${pmenus} Anonymous Chats`, rowId: ".m9 anonymous", description: "Bicara dengan orang tidak dikenal"},
	{title: `📖 ${pmenus} Al-Quran`, rowId: ".m9 quran", description: "Tobat yuk kak"},
	{title: `🌎 ${pmenus} Internet`, rowId: ".m9 internet", description: "Cari sesuatu diBOT"},
  {title: `🌎 ${pmenus} Berita`, rowId: ".m9 berita", description: "Cari berita terupdate"},
	{title: `📩 ${pmenus} Downloaders`, rowId: ".m9 downloader", description: "Download sesuatu diBOT"},
	{title: `🎨 ${pmenus} Stikers`, rowId: ".m9 stiker", description: "Buat Sticker diBOT"},
	{title: `✏️ ${pmenus} Nulis`, rowId: ".m9 nulis", description: "Nulis kok males kak?"},
	{title: `🎧 ${pmenus} Audio`, rowId: ".m9 audio", description: "Ubah Audio dengan Filter"},
  {title: `🎧 ${pmenus} Sound Menu`, rowId: ".soundmenu", description: "Kumpulan 120 Sound"},
	{title: `🏢 ${pmenus} Group`, rowId: ".m9 group", description: "Only Groups"},
	{title: `👑 ${pmenus} Admin`, rowId: ".m9 admin", description: "Only Admin Group"},
	{title: `🗂️ ${pmenus} Database`, rowId: ".m9 database", description: "Simpan sesuatu diBOT"},
	{title: `🛠️ ${pmenus} Tools`, rowId: ".m9 tools", description: "Mungkin tools ini bisa membantu?"},
	{title: `ℹ️ ${pmenus} Info`, rowId: ".m9 info", description: "Info info BOT"},
	{title: `👩‍💻 ${pmenus} Owner`, rowId: ".m9 owner", description: "Owner Only!"},
	{title: `❓ ${pmenus} No Category`, rowId: ".m9 nocategory", description: "Fitur tanpa kategory!"},
	]
  },
]
