...
`.trim()
  conn.sendButton(m.chat, `*${htki} ɪɴᴠᴇɴᴛᴏʀʏ ${htka}*`, caption, imgr + `${command}`, [[`${user.health < 60 ? 'ʜᴇᴀʟ': 'ᴀᴅᴠᴇɴᴛᴜʀᴇ'}`,`${user.health < 60 ? '.heal': '.adventure'}`],['ᴘʀᴏғɪʟᴇ','.pp']],m)
}
handler.help = ['inventory', 'inv']
handler.tags = ['rpg']
handler.command = /^(allinv)$/i
